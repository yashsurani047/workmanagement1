  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={[styles.ghostBtn]} onPress={onBack} disabled={submitting}>
          <Text style={styles.ghostBtnText}>Back</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.primaryBtn, (!canCreate || submitting) && { opacity: 0.6 }]} onPress={onCreate} disabled={!canCreate || submitting}>
          <Text style={styles.primaryBtnText}>{submitting ? 'Creating...' : 'Create Task'}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
